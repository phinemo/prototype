<template>
  ...
  <div uk-slider="center: true">
    ...
    <button class="uk-button uk-button-primary uk-width-1-1 uk-margin-small-bottom uk-margin-medium-top uk-text-small">Lihat semua hal menarik di Semarang</button>
