     ...
     <div class="uk-position-relative uk-visible-toggle uk-light" uk-slider>
            <ul class="uk-slider-items uk-width-3-4 uk-child-width-1-2@s uk-child-width-1-4@m">
                <li v-for="(slider, index) in sliders" :key="index" style="padding-right: 10px;">
                    <div class="uk-margin-small"><img class="uk-box-shadow-small uk-box-shadow-material-small uk-border-rounded" :data-src="slider.image" :alt="slider.title" height="300" width="600" uk-img></div>
